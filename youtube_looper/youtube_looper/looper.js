...
sf_youloop = {
    initialise: function() {
        ...
        this.getVideoElement().addEventListener("ended", func_);
        this.getVideoElement().addEventListener("timeupdate", func_);
    ...
    generateLoopButton: function(){
        ...
        container.innerHTML = `
            <div class="loop_button" onclick="sf_youloop.setLoop(-1, undefined, undefined);"><img src="` + this.rnURL + `loop.png"></img></div>
